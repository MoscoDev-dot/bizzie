...
const NuraWorks = () => {
  return (
    <div id="about" className="bg-[#EDEDED]  ">
      <div className="bg-gradient-to-b from-[#FFFFFF] pt-30  to-[#EDEDED] ">
      ...
      <Container maxWidth={false}>
        <div className="pt-5 lg:px-5">
          <motion.div
            ...
            viewport={{ once: true }}
            className="text-center capitalize pb-10 font-bold lg:text-[48px] md:text-[30px] text-[#25D363] text-[24px] leading-[120%] "
          >
            How Bizzie Works
          </motion.div>
