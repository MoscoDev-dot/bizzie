  ...
  return (
    <div id="" className="bg-[#FFFFFF]  hero-bg lg:pt-30 md:pt-20 lg:px-5 pt-15">
      <Container maxWidth={false}>
        <div>
          <div className="grid grid-cols-1 Core1 md:grid-cols-2 gap-1 md:gap-4 lg:gap-0">
            {/* first col */}
            <motion.div transition={{ duration: 0.5, delay: 0.5, ease: "easeInOut" }}
            initial={{ y: 20, opacity: 0 }} // ANNIMATIONS
            whileInView={{ y: 0, opacity: 1 }}
            viewport={{ once: true }} className="Core1">
              <div className="flex gap-2 mx-3 Core1 md:mx-0 my-2">
                <div   className="mt-2">
                  <Image
                    src="/List.png"
                    alt="hero png"
            ...
            initial={{ y: 20, opacity: 0 }} // ANNIMATIONS
            whileInView={{ y: 0, opacity: 1 }}
            viewport={{ once: true }} className="mt-0 Core1 md:mt-22 lg:mt-0 ">
              <Image
                src="/Component 1.png"
                alt="her0.2.img"
                width={600}
                height={200}
                className="w-auto Core1 h-auto"
              />
            </motion.div>
          </div>
        </div>
