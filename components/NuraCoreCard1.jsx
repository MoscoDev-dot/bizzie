...
const NuraCoreCard1 = ({ text1, text2 }) => {
  return (
    <motion.div
      animate={{ y: ["0%", "-55%"] }} // scroll up then down
        transition={{
          duration: 6, // speed
          ease: "easeInOut",
    ...
    >
      ...
      <div className="bg-[#FEEECD] rounded-[20px] mx-auto   md:w-60 w-50  mb-5 p-3">
        <div className="flex ">
          <span>
      ...
      <div className="mx-5">
        <p className="font-bold text-[#25D363] pt-3 md:text-[24px] text-[15px] leading-[120%] ">
          {text1}
        </p>
